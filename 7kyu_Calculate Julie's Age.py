...
# Calculate Julie's Age -- Codewars -- 7kyu
...
# 
# Do not concern yourself with the imperfections
# inherent in dividing by floating point numbers, as your answer will be rounded.
